 ...
 * Features: Loading state, closed/unavailable message, disabled unavailable slots, selectable available slot buttons, selected styling, and stable unavailable labels.
      ...
      {slots.map((rawSlot) => {
        ...
        return (
          <button
            ...
            onClick={() => {
              if (!isUnavailable) onChange(slot.time);
            }}
